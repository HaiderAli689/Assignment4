const favoriteNumber: number = 42; // Change this to your favorite number
...
function inviteAdditionalGuests(currentGuests: string[]): string[] {
    const additionalGuests: string[] = ["Frank", "Grace", "Hannah"];
    const updatedGuests = [...currentGuests, ...additionalGuests];
    return updatedGuests;
  }
  
  const initialGuests: string[] = ["Alice", "Bob", "Charlie", "David", "Eve"];
  ...
  const names1: string[] = ["Alice", "Bob", "Charlie", "David", "Eve"];
...
const placesToVisit: string[] = [
  ...
  function inviteAdditionalGuests1(currentGuests: string[]): string[] {
    const additionalGuests: string[] = ["Frank", "Grace", "Hannah"];
    const updatedGuests = [...currentGuests, ...additionalGuests];
    return updatedGuests;
  }
  
  const initialGuests1: string[] = ["Alice", "Bob", "Charlie", "David", "Eve"];
...
const countriesInfo: { name: string; capital: string; population: number }[] = [
    {
      name: "Pakistan",
      capital: "Islamabad",
...
const usernames: string[] = ["admin", "Eric", "Alice", "Bob", "Jane"];
